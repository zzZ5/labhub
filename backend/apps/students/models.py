...
class StudentProfile(models.Model):
    ...
    supervisor = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, related_name="supervised_students", verbose_name="主导师", null=True, blank=True)
    advisors = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name="advised_students", verbose_name="导师", blank=True)
