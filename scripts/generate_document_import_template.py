...
def main():
    ...
    guide["A4"] = "分类"
    guide["B4"] = "建议填写：组内制度与通知、实验室安全、实验方法、项目与经费材料、论文写作与投稿、组会与学术交流、行政表格与模板。也可以填写分类 slug。"
    guide["A5"] = "可见范围"
    guide["B5"] = "可填写：组内成员可见、博士/管理员可见、硕博导师/管理员可见、公开。留空默认组内成员可见。"
    guide["A6"] = "允许下载"
    guide["B6"] = "可填写：是/否。留空默认允许下载。"
    guide["A7"] = "重复标题"
    guide["B7"] = "标题重复时会更新原资料；普通成员只能更新自己有权编辑的资料。"
    ...
    examples = [
        ["堆肥样品前处理流程", "实验方法", "组内成员可见", "样品采集、保存、前处理和记录要求。", "堆肥样品前处理流程.pdf", "是"],
        ["组会汇报模板", "组会与学术交流", "组内成员可见", "组会汇报 PPT 模板。", "组会汇报模板.pptx", "是"],
        ["项目报销材料清单", "项目与经费材料", "硕博导师/管理员可见", "项目经费材料准备参考。", "项目报销材料清单.docx", "否"],
    ]
    data.append(headers)
    for row in examples:
        data.append(row)
    style_sheet(data)
    widths = [28, 20, 22, 42, 34, 14]
