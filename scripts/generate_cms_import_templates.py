...
TEMPLATES = {
    ...
    "publications-import-template.xlsx": {
        ...
        "notes": [
            ...
            "必填：论文题目、作者、年份。系统优先按 DOI 更新已有论文；DOI 为空时按论文题目和年份匹配。",
            "可见范围可填写：公开、成员可见、管理员可见。",
            "PDF 附件列只作提醒；批量导入先导入文字信息，PDF 请在单条论文编辑页面上传。",
        ],
        "headers": ["论文题目", "作者", "期刊", "年份", "DOI", "可见范围", "摘要", "PDF附件", "排序"],
        "rows": [
            ["示例论文题目", "作者1; 作者2; 作者3", "Environmental Research", 2026, "10.0000/example", "公开", "填写论文摘要。", "导入后在单条论文中上传 PDF", 10],
        ],
        "widths": [44, 36, 28, 10, 24, 14, 52, 28, 10],
    },
    "projects-import-template.xlsx": {
        ...
        "notes": [
            ...
            "门户展示建议保留项目方向、资助来源、负责人和状态，不必填写敏感细节。",
            "日期格式建议使用 YYYY-MM-DD。",
        ],
        "headers": ["项目名称", "项目编号", "资助来源", "负责人", "状态", "开始日期", "结束日期", "可见范围", "说明", "首页排序"],
        "rows": [
            ["有机废弃物资源化与堆肥过程调控研究", "项目编号示例", "国家级/省部级科研项目", "团队负责人", "在研", "2026-01-01", "2028-12-31", "公开", "门户展示版说明。", 10],
        ],
        "widths": [42, 22, 30, 16, 12, 14, 14, 14, 46, 12],
    },
